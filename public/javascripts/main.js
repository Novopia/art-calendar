...
$(document).ready(function(){
	...
	// sends the following post request, and the date should be in format of the example.
	// The example queries for events starting at 20160510. It includes events started
	// earlier but are still ongoing.

	//$.post("/month/20160510", function(responseJSON){
	//	console.log("got here in 20160510");
	//	console.log("row count is " + responseJSON.rowCount);
	//});
